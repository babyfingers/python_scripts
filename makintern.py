...
print "Initial distance = "+str(dist_init)+" a.u.\n"
...
while (not converged):
    ...
    #Print distance
    print "Distance on iteration "+str(i)+": "+str(dist_now)+" a.u.\n"
#Output
...
print geo0_f-geo1_f
print "Initial distance apart = "+str(dist_init)+" a.u., final distance apart = "+str(dist_now)+" a.u."
