...
# previous calculations. (Hence the special Q-Chem script, solqchem.csh.
...
if (mode1==2 or mode1==3 or mode1==4):
    ...
    os.system("grep xxMOxOvr_altxx *"+filenamebase+outfilenameend+" > MOxOvr_alt.txt")
    print "Now analyzing the output."
    quant = ["MOxOvr_std","cMOxOvr_stdaa1","cMOxOvr_stdaa2","cMOxOvr_stdab1","cMOxOvr_stdab2","MOxOvr_alt"]
    quantfn = ["MOxOvr_std.txt","cMOxOvr_stdaa1.txt","cMOxOvr_stdaa2.txt","cMOxOvr_stdab1.txt","cMOxOvr_stdab2.txt","MOxOvr_alt.txt"]
    numq = len(quant)
