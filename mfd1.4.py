...
# v1.4: modified for the new use of the tia_order variable again.
# As of 2012-04-24, this is the code:
# tia_order = -3 make cross-geometry S matrix in stvman/mkSTV.C, crash.
#             -2 same as above
#              0 do nothing special, no special ordering of states
#              1 'lite' overlap ordering from previous calculation
