...
maxjobs = 10 #If we just do all the jobs at once, how many should we run at a time?
...
sS  = 'S'
eols = "\n"
tm = 5.0 #Seconds between issuing qstat
...
if (len(str(Tarr[0]).zfill(max_cbp_e))+len(str(earr[0]).zfill(max_cbp_T))>6):
